...
export class HomeService {
  ...
  private fetchInsights(): any {
    ...
    const insightsUrl = 'http://localhost:8080/CPTRestSecure/app/portfolio/getSymbolData?uid=1024494&symbol=A&components=pgr%2CmetaInfo%2CfundamentalData%2CEPSData';
